          ...
          <div class="card-body">
            ...
            <form action="{{ route('produk.update', $itemproduk->id) }}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" name="kode_produk" id="kode_produk" value="{{ $itemproduk->kode_produk }}"
                  class="form-control" required>
              </div>

              <div class="form-group">
                <label for="nama_produk">Nama Produk</label>
                <input type="text" name="nama_produk" id="nama_produk" value="{{ $itemproduk->nama_produk }}"
                  class="form-control" required>
              </div>

              <div class="form-group">
                <label for="slug_produk">Slug Produk</label>
                <input type="text" name="slug_produk" id="slug_produk" value="{{ $itemproduk->slug_produk }}"
                  class="form-control" required>
              </div>
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group">
                    ...
                    <input type="text" name="qty" id="qty" value="{{ $itemproduk->qty }}" class="form-control" required>
                  </div>
                </div>
                <div class="col">
                  <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="harga" id="harga" value="{{ $itemproduk->harga }}" class="form-control" required>
              </div>
